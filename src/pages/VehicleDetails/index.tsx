...
const VehicleDetailsPage: React.FC = () => {
    ...
    // probs could be individual state, but was trying to clean this up a bit
    ...
    useEffect(() => {
        const fetchVehicle = async () => {
            try {
                ...
                const response = await fetch("/vehicles.json"); // Assuming this will be the retailers API endpoint in a real app although had a bit of a struggle
                if (!response.ok) {
                ...
                setDeposit(foundVehicle.price * 0.1); // Default deposit is 10% of the price
            } catch (err: any) {
    ...
    return (
        <div className="vehicle-details-page">
            ...
            <section className="vehicle-details-container">
                ...
                <div className="vehicle-finance-calculator">
